const sections = [
  ...
  {id:'setup',title:'Setup',intro:'Setup starts at 8:00 AM. Finish the public-facing room well before guests arrive.',cards:[
    {title:'Venue / room',tasks:['Confirm venue access at 8:00 AM','Walk venue before unloading','Identify electrical outlets/circuits','Identify emergency exits and keep clear','Identify restrooms','Identify guest entrance and lobby flow','8 round tables — venue already placed from the floor plan. Confirm only.','64 chairs — venue already placed. Confirm only.','Horseshoe — venue already built. Do not rebuild.','Dance floor — venue already open in front of the stage. Do not rebuild.','Keep aisles and sightlines clear','4 rectangular buffet tables — venue already placed at entry. Confirm only.','4-foot ticket table — venue already placed in lobby. Confirm only.','Set up beverage station','Set up sign pickup area','Set up campaign information/display area','Set up performer/backstage area if needed']},
  ...
  {id:'volunteers',title:'Volunteers',intro:'Build the roster before Thursday. Each person should have a job, arrival time, and backup plan.',cards:[
    {title:'Morning setup — 8:00 AM',tasks:['Assign setup captain','Venue already placed tables, chairs, horseshoe, and dance floor','Recruit tablecloth/decor crew','Recruit campaign-material crew','Recruit sign crew','Recruit lobby/ticket setup person','Recruit beverage/cooler crew','Recruit general runner/floater']},
  ...
  {id:'production',title:'Sound & Show',intro:'Tracy Morgan owns lights, sound, and electrical. One campaign volunteer stays with her from 8:00 AM through Strike D. Photo/video is a different person.',cards:[
    {title:'Tracy / production',tasks:['Tracy owns the one production system — do not build a second sound or light plot','Name the campaign volunteer helper — arrives 8:00 AM and stays through Strike D','Helper job: cables, tape, water, fetch. Do not leave at encore','Unload and place one system: speakers, mixer, mics, stands, lights','Map outlets and circuits — one safe power plan','Run and tape cables so the dance floor stays clear','Spare batteries staged at the mixer','One full sound and light check before guests','Write any extra Tracy requirement here']},
    {title:'David acoustic set — about 5:45–6:15',tasks:['Someone must bring a bar stool and set it center floor — venue does not provide one','David acoustic guitar + his amplification only','One vocal mic and stand at the stool','Center-floor light on David','David water at the stool','Test the acoustic position','Start ~5:45 PM','Wrap ~6:15 PM','Clear every piece of acoustic gear before 6:30 doors']},
    {title:'7:00 concert',tasks:['6:45 PM checkpoint with Event Captain — stage is ready','Run sound and lights for the 7:00 show','Stay on deck through the last song — then Strike D']}
  ]},
