(function (global) {
  ...
  const ROLES = [
    ...
    },
    {
      ...
      priority: 3,
      test: /tracy|sound\/lights muscle|full sound and light|bar stool|center-floor|load tracy|stay on deck through the last song/i,
      roster: /sound\/lights muscle|tracy/i,
      day: [
        ...
        { start: "2026-09-17T20:45:00", end: "2026-09-17T22:00:00", place: "Strike D · stage", do: "Pack production. Anyone free + 3 muscle carry lights and sound out. Tracy directs." },
      ],
    },
    {
      id: "tickets",
    ...
    },
    {
      ...
      day: [
        { start: "2026-09-17T16:30:00", end: "2026-09-17T17:30:00", place: "Serving line", do: "On site at 4:30. Set the line. Ice now. Do not plate. Drink donations live at merch. Water is someone else." },
    ...
    },
    {
      ...
      label: "Drink station",
      priority: 3,
      test: /\$1 water|\$1 bottles|water girl|money bag for \$1|drink donation|donations for drinks|water \/ drinks|drink station/i,
      roster: /drink station|\$1 bottles only|water — \$1|water — donations|donations for water/i,
      day: [
        { start: "2026-09-17T16:30:00", end: "2026-09-17T17:30:00", place: "Drink station", do: "On site at 4:30. Ice in. Tea and lemonade full. Hand out water. Ask for donations." },
    ...
    },
    {
      ...
      priority: 2,
      test: /floater|relief loop|relief lead|production manager/i,
      roster: /floater|relief lead|production manager/i,
      day: [
        { start: "2026-09-17T17:30:00", end: "2026-09-17T18:30:00", place: "The plan", do: "Arrive by 5:30 if you can. Keep the night on plan. Fill gaps. Point people. Ask if anyone needs a break." },
        { start: "2026-09-17T18:30:00", end: "2026-09-17T19:15:00", place: "Doors + loop", do: "Production Manager 1 helps tickets at doors. Production Manager 2 keeps the loop moving." },
        { start: "2026-09-17T19:15:00", end: "2026-09-17T20:45:00", place: "Show floor", do: "One Production Manager always walking so someone can take a break." },
