  ...
  const PEOPLE = [
    {
      ...
      title: "Event Captain",
      next: "You are at doors when they open and when they close. Last check at the end. Available all day.",
      duties: [
        "Available for setup help in the morning if they need a hand.",
  ...
  const JOBS = [
    {
      ...
      arrival: "4:30 PM · earlier if setup needs a hand",
