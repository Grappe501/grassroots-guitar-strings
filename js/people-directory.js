(function (global) {
  const PEOPLE = [
    ...
    },
    {
      ...
      next: "Kelly Support and Photo stay with you. You greet, thank, and move. You do not run tickets, food, or merch.",
      duties: [
        "5:00–close: be with guests.",
        "Kelly Support (Robin until claimed) is your runner.",
        "Photo/Video (Jimmy Olsen until claimed) stays on you. Vertical only.",
  ...
  const JOBS = [
    ...
    },
    {
      ...
      cartoon: "Robin",
      arrival: "5:00 PM",
      owns: "Kelly's runner. She only presses flesh.",
      duties: [
        "Stay with Kelly. Water, intros, move a pull-up if she asks.",
        "Do not park her at tickets, food, or merch.",
        "Photo/Video stays on her too. You two do not leave her uncovered.",
    ...
    },
    {
      ...
      weight: "On Kelly all night",
      cartoon: "Jimmy Olsen",
      arrival: "5:00 PM",
      owns: "Vertical only. Assigned to Kelly.",
      duties: [
        "You are Kelly's camera for the night. Not a roaming extra.",
        "Vertical only: guests with Kelly, David, the room, the work.",
        "One closing group frame. Then help the final walk.",
        "If no one claims this seat, Relief Lead shoots between loops.",
      ],
    },
    {
      id: "strike",
