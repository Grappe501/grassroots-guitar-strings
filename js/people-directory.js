  ...
  const PEOPLE = [
    {
      ...
      kicker: "EVENT LEAD",
      title: "Event Lead",
      next: "You own Thursday. Arrive 4:30. The clock, every post, strike, 10:00 clear.",
      duties: [
    ...
    },
    {
      ...
      duties: [
        ...
        "Drink donations live at this table. 120 bottles. Water, tea, or lemonade. Money bag on you. Not a second station.",
        "Merch 2 arrives at 6:00 for the rush between David and the 7:00 show. They greet, hand materials, and take donations.",
    ...
    },
    {
      ...
      duties: [
        ...
        "12:30 release the 3 dressers. They are done unless they also claimed a night seat. Relief is a different night seat at 5:30. Path signs stay until strike.",
  ...
  const JOBS = [
    {
      ...
      duties: [
        "4:30 arrive. Event t-shirt on. Open My Night. That clock is your script.",
        "4:35 walk the room, lobby, merch, lot. Do not rebuild furniture.",
        "4:35 confirm every night post is walking in. Text anyone missing.",
        "4:40 eat 15 minutes. Then ice with Ben. 12 bags in chests, not still in a car.",
        "4:30 sound check. Stay off the dance floor.",
        "5:15 food doors. Tell every night person: you stay until 10. Concert-only stay in cars until 6:30.",
    ...
    },
    {
      ...
      duties: [
        ...
        "12:30 release the 3 dressers. They eat lunch off site. They are done unless they also claimed a night seat. Relief is a different night seat at 5:30. Path signs stay until strike.",
        "You are done unless you also claimed a night seat. If you did, open that seat on My Night at 4:30.",
      ],
    },
    {
      ...
      duties: [
        ...
        "5:15 food doors. Table is live. Cash box never sits open and empty. Envelopes stay on you. Kids $5 with an adult.",
    ...
    },
    {
      ...
      duties: [
        ...
        "If you only work night: 4:30 t-shirt on. Open My Night. Table live. Drinks live here. 120 bottles on ice. Donations for water, tea, or lemonade. Money bag on you.",
        "4:40 eat 15 minutes. Sign: back in 10. Bottles stay on ice.",
        "4:30 stay off the dance floor. Sound check.",
        "5:25 talk. Take drink donations from this table. Script: we are taking donations for drinks — water, tea, or lemonade. Do not leave shirts in a pile guests have to dig. Wave Relief each hour for 10 minutes.",
        "5:45 close the table. Sign: open after David. Ice the bottles. Sit the dinner show.",
        "6:15 table back up. Merch 2 is your extra hands for the rush. Water back up. 6:30 concert-door browse window. Stay.",
        "7:15 close again. Sit the concert 45 minutes. Relief comes get you if a line forms. They sell water from this table while you sit.",
        "8:00 table through encore. Water through the last song. Box loose shirts so strike is 20 minutes.",
        "8:45 Strike B. Leftover water packed. Water cash to Event Lead. Campaign signs, both shirt stacks, push cards, foldovers, pull-up, hanging banners, pens, pins, stakes, postcards, cash / checks, cloths, conversation cards. Count. Bins to the campaign vehicle.",
      ],
    },
    {
      id: "production",
    ...
    },
    {
      ...
      owns: "Floater A. Night relief only. Breaks, ice, trash. Doors with tickets.",
      duties: [
        "Night only. No morning. No setup. Arrive by 5:30 if you can. Event t-shirt on. Open My Night.",
        "5:30 eat 15 minutes if you have not. Then you work David on purpose.",
        "5:45 take tickets so they can sit David. Stand lobby. Listen from the door.",
        "6:10 hand tickets back. Loop: tickets 10, food 10, campaign 10. Ice and trash between.",
        "6:30 concert doors. Stand with Tickets 15 minutes. No pile-up.",
        "6:45 quiet loop. Trash. Ice if Food or Drink station waves.",
        ...
        "8:45 pair up when Event Captain calls it. Venue furniture stays.",
      ],
    },
    {
      id: "relief2",
      ...
      arrival: "5:30 PM if you can",
      owns: "Floater B. Night relief only. Food cover. Roam shots if Photo Lead is empty.",
      duties: [
        "Night only. No morning. No setup. Arrive by 5:30 if you can. Event t-shirt on. Open My Night. Start on FOOD so you are offset from Relief 1.",
        "5:30 eat 15 minutes if you have not. Then you work David on purpose.",
        "5:45 dinner show. You work. 10-minute food restrooms only. Listen from the buffet.",
        "6:15 help clear the dance floor. Then loop: food 10, campaign 10, tickets 10. Never stack on Relief 1.",
        "6:30 doors — keep the loop. Relief 1 is at tickets.",
        "7:20 cover the drink station so they can sit. Check ice every 15 minutes. Keep tea and lemonade full.",
        ...
        "8:45 pair up when Event Captain calls it.",
      ],
    },
    {
      id: "kelly",
