(function (global) {
  const PEOPLE = [
    ...
    },
    {
      ...
      next: "Pick a seat when Steve names one. Arrive 4:30.",
      duties: [
    ...
    },
    {
      ...
      duties: [
        ...
        "12:30 release the 3 dressers. Path signs stay until strike. Floater A pulls roadside/entrance signs tonight.",
  ...
  const JOBS = [
    ...
    },
    {
      ...
      duties: [
        ...
        "12:30 release the 3 dressers. They eat lunch off site. They come back as Floater A, Floater B, or Campaign. Path signs stay until strike.",
        "You are done unless you also claimed a night seat. If you did, open that seat on My Night at 4:30.",
      ],
    },
    {
    ...
    },
    {
      ...
      duties: [
        "If you are Setup 1: 10:00 dress 8 tables. Signs + lobby. Leave 12:30. Lunch off site.",
        "4:30 night arrival. T-shirt on. Open My Night. Ice with Food. Walk every post once.",
        "4:40 eat 15 minutes. This is your dinner. You work David on purpose.",
        "4:30 sound check. Stay off the dance floor.",
    ...
    },
    {
      ...
      duties: [
        "If you are Setup 2: 10:00 dress 8 tables. Signs with Setup 1. Leave 12:30. Lunch off site.",
        "4:30 night arrival. T-shirt on. Open My Night. Start the loop on FOOD first so you are offset from Relief 1.",
        "4:40 eat 15 minutes. This is your dinner. You work David on purpose.",
        "4:30 sound check. Stay off the dance floor.",
        ...
        "7:20 cover merch water so they can sit the concert. Check ice every 15 minutes.",
