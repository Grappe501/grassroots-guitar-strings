  ...
  const PEOPLE = [
    ...
    },
    {
      ...
      duties: [
        ...
        "Tea and lemonade are free while they last. Ice chest + scoop for those drinks. Water is $1 cash at the merch table — not your station.",
    ...
    },
    {
      ...
      next: "Campaign & Merch is your seat. One table. 30-minute set. Water is sold here. $1 cash.",
      duties: [
        ...
        "Water is sold at this table. 120 bottles. $1 cash only. Money bag on you. Ones for change. Not a second station.",
  ...
  const JOBS = [
    ...
    },
    {
      ...
      duties: [
        ...
        "10:05 walk room, exits, lobby. Then the 3 dress 8 guest tables only — cloth + simple center. 25 minutes.",
        ...
        "11:00 merch done. Yard-sign sheet on that table. Walk once. Fix only what is ours.",
        "12:00 room is dressed. Tracy is on his own system. Band is not your problem this morning.",
        "12:30 release the 3 dressers. They eat lunch off site. They come back as Floater A, Floater B, or Campaign.",
    ...
    },
    {
      ...
      duties: [
        "3:00 arrive. Earlier if you can. Event t-shirt on. Open My Night. Walk the buffet. Three servers should be with you. Water is sold at merch. Not your station.",
        ...
        "5:30 BBQ open. Keep the line moving. Refill pans. Do not plate guest plates. Water is sold at merch. $1 cash.",
        ...
        "6:30 line closes. Thank the three servers. Merch keeps selling water. You are off the line.",
    ...
    },
    {
      ...
      duties: [
        ...
        "If you only work night: 3:00 t-shirt on. Earlier if you can. Open My Night. Table live. Water lives here. 120 bottles on ice. $1 cash only. Money bag on you. Ones for change.",
        "3:15 eat 15 minutes. Sign: back in 10. Bottles stay on ice.",
        "4:30 stay off the dance floor. Sound check.",
        "5:25 talk. Sell water from this table. Script: water is $1 cash — or free tea and lemonade at the drink station. Do not leave shirts in a pile guests have to dig. Wave Relief each hour for 10 minutes.",
