  ...
  const JOBS = [
    {
      ...
      duties: [
        ...
        "4:35 walk the room, lobby, merch, lot. Do not rebuild furniture. Stay off the dance floor during sound check.",
        "4:40 confirm every night post has a body. Text anyone missing.",
        "4:50 ice check with Ben. 12 bags in chests, not still in a car.",
        "5:00 dinner doors. Tell every night person: you stay until 10. Concert-only stay in cars until 6:30.",
        "5:10 eat 15 minutes. Then walk tickets, food, campaign, lot every 15 minutes. One sentence: you good?",
    ...
    },
    {
      ...
      duties: [
        "5:00 dinner doors. Event t-shirt on. Open My Night. Venue already placed the 4-ft lobby table.",
        "5:02 dress it: cash box, envelopes, pens, $25 sign, teacher/first-responder note. 10 minutes.",
        "5:10 eat 15 minutes behind the table. If a guest walks up, take them, then go back to the plate.",
        "5:25 table is live. Dinner guests check in. Cash box never sits open and empty. Envelopes stay on you.",
    ...
    },
    {
      ...
      duties: [
        "4:30 arrive. Event t-shirt on. Open My Night. Walk the buffet. Three servers should be with you. Water is not your station.",
        "4:35 ice chest + scoop for tea and lemonade. Set the line. Signs: tea and lemonade free while it lasts. You do not plate.",
        "4:50 eat 15 minutes. Then the line owns you.",
        "5:05 brief Sarah and the two other servers. One line. You direct. They serve. You still do not plate.",
    ...
    },
    {
      ...
      duties: [
        ...
        "9:00 yard-sign sheet on the same table. First name + phone. Morning done 10:30. Lunch off site. Back 5:00.",
        "If you only work night: 5:00 t-shirt on. Open My Night. Table live.",
        "5:10 eat 15 minutes. Sign: back in 10.",
    ...
    },
    {
      ...
      duties: [
        ...
        "4:45 eat 15 minutes. This is your dinner. You work David on purpose.",
    ...
    },
    {
      ...
      duties: [
        "5:00 arrive. Event t-shirt on. Open My Night. Find Kelly. You are the only staff on her.",
    ...
    },
    {
      ...
      duties: [
        "5:00 arrive. Event t-shirt on. Open My Night. You roam. You are not Kelly's minder.",
    ...
    },
    {
      ...
      duties: [
        "You stay all night on your other seat if you have one. Open My Night. Strike focus starts 8:30.",
