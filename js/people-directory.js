  ...
  const JOBS = [
    ...
    },
    {
      ...
      duties: [
        ...
        "Stay on the table unless a Production Manager relieves you. If they do, the box goes with a named person.",
        "If you left the table, take the box back. Count envelopes once.",
        "6:30 concert doors. 15-minute rush. Production Manager 1 stands with you. Overflow to the wall, not the door.",
        "Rush over. Box on your body. Stay on the table unless a Production Manager relieves you.",
    ...
    },
    {
      ...
      duties: [
        ...
        "If you only work night: 4:30 t-shirt on. Open Tonight. Table live. Drinks live here. 120 bottles on ice. Donations for water, tea, or lemonade. Money bag on you.",
        "4:40 eat 15 minutes. Sign: back in 10. Bottles stay on ice.",
        "4:30 stay off the dance floor. Sound check.",
        "Take drink donations from this table. Script: we are taking donations for drinks — water, tea, or lemonade. Do not leave shirts in a pile guests have to dig.",
