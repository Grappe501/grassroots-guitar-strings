  ...
  const SPOTS = [
    {
      ...
      clock: [
        row("16:30", "arrive", "Arrive. Event t-shirt on before you talk to anyone. Open My Night. Phone on silent, vibrate on."),
        row("16:32", "work", "Sound check is on the dance floor. Do not walk it. Stand the edge. Confirm Tracy and the band have what they need."),
        row("16:35", "work", "Walk 8 guest tables, lobby, buffet, merch, lot. 5 minutes. Do not fix venue furniture."),
        row("16:40", "work", "Confirm every night post has a body: tickets, Ben + 3 servers, water, campaign, both floaters, Kelly Support, Photo, 3 arrival. Text anyone missing."),
        row("16:50", "work", "Ice check with Ben. 12 bags in chests, not in a car. Water girl has 120 bottles and the money bag."),
        ...
        row("17:10", "eat", "EAT. 15 minutes. Plate in the back. Do not start a meeting with food in your hand."),
    ...
    },
    {
      ...
      clock: [
        row("17:00", "arrive", "Dinner doors. Event t-shirt on. Open My Night. Concert-only guests wait in cars until 6:30."),
        row("17:02", "work", "Dress the lobby table: cash box, envelopes, pens, $25 sign, teacher/first-responder note. 10 minutes. Venue already placed the table."),
        row("17:10", "eat", "EAT. 15 minutes behind the table. If a guest walks up, take them, then go back to the plate."),
        row("17:25", "work", "Table is live. Dinner guests check in. Cash box never sits open and empty. Envelopes stay on you."),
    ...
    },
    {
      ...
      clock: [
        row("16:30", "arrive", "Arrive. Event t-shirt on. Open My Night. Walk the buffet. Three servers should be with you. Water is not your station."),
        row("16:35", "work", "Ice chest + scoop for tea and lemonade. Set the line. Signs: free while it lasts. You do not plate."),
        row("16:50", "eat", "EAT now. 15 minutes. Then the line owns you."),
        row("17:05", "work", "Brief Sarah and the two other servers. One line. You direct. They serve. You still do not plate."),
    ...
    },
    {
      ...
      clock: [
        row("16:30", "arrive", "Arrive. Event t-shirt on. Open My Night. Find Ben. You are Server 1 · Sarah."),
        row("16:35", "work", "Help set the line. Pans, utensils, plates at the start. Tea and lemonade are free while they last. Do not take the water station."),
    ...
    },
    {
      ...
      clock: [
        row("16:30", "arrive", "Arrive. Event t-shirt on. Open My Night. Find Ben. You are Server 2."),
    ...
    },
    {
      ...
      clock: [
        row("16:30", "arrive", "Arrive. Event t-shirt on. Open My Night. Find Ben. You are Server 3."),
        row("16:35", "work", "Help set the line. Tea and lemonade are free while they last. Do not take the water station."),
        row("16:50", "eat", "EAT now. 15 minutes."),
        row("17:05", "work", "Stand your spot. Ben briefs. You serve. You do not plate. You do not sell water."),
        row("17:30", "work", "Line is open. Serve. Smile. Ben directs."),
    ...
    },
    {
      ...
      clock: [
        row("16:30", "arrive", "Arrive. Event t-shirt on. Open My Night. You are water. Not the serving line."),
        row("16:35", "work", "120 bottles on ice. $1 cash-only signs up. Money bag on you. Ones for change. Tea and lemonade are free over there — leave them alone."),
        row("16:50", "eat", "EAT now. 15 minutes."),
    ...
    },
    {
      ...
      clock: [
        row("08:00", "arrive", "If you are Setup 3: arrive. Event t-shirt on. Open My Night. Three people dress 8 guest tables only."),
        row("08:25", "work", "Tables done. You set merch — 30 minutes. 4-ft and 6-ft campaign tablecloths. Hang two banners with bungee cords. Conversation cards on guest tables. Push cards, buttons, candy, foldovers, shirts."),
        ...
        row("17:00", "arrive", "Night arrival. T-shirt on. Open My Night. Table live."),
        row("17:10", "eat", "EAT. 15 minutes. Sign: back in 10. Do not skip this."),
        ...
        row("20:45", "strike", "Strike B. Banners, bungees, both campaign cloths, conversation cards, count, bins to the campaign vehicle. 20 minutes."),
    ...
    },
    {
      ...
      clock: [
        ...
        row("10:30", "work", "Room dressers may leave. You stay with Tracy or take a short break if he says so."),
    ...
    },
    {
      ...
      clock: [
        row("08:00", "arrive", "If you are Setup 1: arrive. Event t-shirt on. Open My Night. Dress 8 guest tables with Setup 2 and 3."),
        ...
        row("16:30", "arrive", "Night arrival. T-shirt on. Open My Night. Ice with Food. Walk every post once."),
        row("16:45", "eat", "EAT. 15 minutes. This is your dinner. You work David on purpose."),
    ...
    },
    {
      ...
      clock: [
        row("08:00", "arrive", "If you are Setup 2: arrive. Event t-shirt on. Open My Night. Dress 8 guest tables with Setup 1 and 3."),
        row("08:25", "work", "Tables done. Signs with Setup 1. Help lobby if they need 10 minutes."),
        row("10:30", "leave", "Morning done. Leave. Eat lunch off site. Back at 4:30."),
        row("16:30", "arrive", "Night arrival. T-shirt on. Open My Night. Start the loop on FOOD first so you are offset from Relief 1."),
        row("16:45", "eat", "EAT. 15 minutes. This is your dinner. You work David on purpose."),
    ...
    },
    {
      ...
      clock: [
        row("16:45", "arrive", "Arrive. Event t-shirt on. Open My Night. EAT now. 15 minutes. Then you will not eat until after 6:45."),
    ...
    },
    {
      ...
      clock: [
        row("16:45", "arrive", "Arrive. Event t-shirt on. Open My Night. EAT. 15 minutes."),
    ...
    },
    {
      ...
      clock: [
        row("16:45", "arrive", "Best night: arrive now. Event t-shirt on. Open My Night. EAT. 15 minutes. You are a guest until 8:45."),
    ...
    },
    {
      ...
      clock: [
        row("16:45", "arrive", "Best night: arrive now. Event t-shirt on. Open My Night. EAT. Then you are a guest until 8:45."),
    ...
    },
    {
      ...
      clock: [
        row("16:45", "arrive", "Best night: arrive now. Event t-shirt on. Open My Night. EAT. Guest until 8:45."),
        row("17:00", "sit", "No post. Walk, greet, sit. Do not take over a table."),
        row("17:45", "sit", "SIT the dinner show. Whole set."),
        row("19:00", "sit", "SIT the concert. Phone on silent."),
        row("20:40", "arrive", "Be by the stage. Event t-shirt on. Find Tracy."),
    ...
    },
    {
      ...
      short: "Morning room",
      arrive: "8:00 AM",
      eat: "Lunch off site after 10:30. Night only if you also claimed a night seat.",
      sit: "You sit a night show only if you also hold a night seat.",
      leadJob: "setup",
      roster: [{ kind: "setup", hint: /setup captain|setup lead/i }],
      why: "You own the 90-minute room. Three dressers. Then they become night seats. You are done at 10:30 unless you also claimed a night job.",
      clock: [
        row("08:00", "arrive", "Arrive. Event t-shirt on. Open My Night. Gather the 3 dressers. Furniture is already placed. Do not rebuild."),
        row("08:05", "work", "Walk room, exits, lobby. Then the 3 dress 8 guest tables only — cloth + simple center. 25 minutes."),
        row("08:25", "work", "Tables done. Setup 1+2: signs 15, lobby cloth 10. Setup 3: 30-minute merch set. 4-ft and 6-ft campaign cloths, two banners + bungees, conversation cards."),
        row("08:40", "work", "Tea and lemonade station. No ice. Ice waits until 4:30."),
        row("09:00", "work", "Merch done. Yard-sign sheet on that table. Walk once. Fix only what is ours."),
        row("10:00", "work", "Room is dressed. Tracy is on his own system. Band is not your problem this morning."),
        row("10:30", "leave", "Release the 3 dressers. Lunch off site. They come back as Floater A, Floater B, or Campaign."),
        row("16:30", "arrive", "Come back only if you also claimed a night seat. Open that seat on My Night. This page is done."),
      ],
    },
    {
      id: "kelly",
      ...
      arrive: "5:00 PM",
      eat: "5:10 PM · 10 min with Kelly or right behind her.",
      ...
      clock: [
        row("17:00", "arrive", "Arrive. Event t-shirt on. Open My Night. Find Kelly. Water in your hand or on her table."),
        row("17:10", "eat", "EAT 10 minutes with her or right behind her. Then you do not leave her."),
    ...
    },
    {
      ...
      clock: [
        row("17:00", "arrive", "Arrive. Event t-shirt on. Open My Night. You roam. You are not Kelly's minder."),
        row("17:05", "work", "Arrivals, lot, lobby, tickets. Journalistic. Energy."),
        row("17:15", "eat", "EAT 10 minutes. Then the camera owns you."),
    ...
    },
    {
      ...
      short: "10:00 clear",
      arrive: "Stay all night · focus 8:30 PM",
      eat: "Eat on your other seat's clock. If this is your only seat, plate at 5:10.",
      ...
      clock: [
        row("17:00", "work", "If this is your only seat: Event t-shirt on. Open My Night. Walk with Event Lead. Then stay out of posts."),
        row("17:10", "eat", "If this is your only seat: EAT 15 minutes. Then you are a guest until 8:30."),
