  ...
  const SPOTS = [
    {
      ...
      clock: [
        ...
        row("17:00", "work", "Tell every night person: you stay until 10. Ben leads the line — he does not plate. Water is separate. Tea and lemonade are free while they last. Take pictures. Post. Tag @KellyGrappeSOS, invite her to collaborate, hashtag #GrappeSOS. Floaters cover breaks. Arrival people own lot, path, lobby until 6:45."),
    ...
    },
    {
      ...
      sit: "You run the dinner-show line. Sit the concert 7:20–8:00. You do not plate. You are not water.",
      leadJob: "food",
    ...
    },
    {
      ...
      arrive: "4:30 PM",
      eat: "4:50 PM · 15 min before the line opens.",
      sit: "You work David on the line. Concert 7:20–8:00.",
    ...
    },
    {
      ...
      sit: "You work David and most of the concert. Relief 2 covers 7:20–8:00 so you sit 40 min.",
