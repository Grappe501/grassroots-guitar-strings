(function (global) {
  ...
  const SPOTS = [
    ...
    },
    {
      ...
      why: "One person at the lobby table. Cash box stays on you unless a Production Manager takes it.",
      clock: [
        ...
        row("17:45", "work", "Stay on the table unless a Production Manager relieves you. If they do, the box goes with a named person."),
        row("18:10", "work", "If you left the table, take the box back. Count envelopes once."),
        ...
        row("19:00", "work", "Stay on the table unless a Production Manager relieves you. If a line forms, you are back."),
        row("20:20", "work", "Check the lobby. Stay if anyone is waiting."),
    ...
    },
    {
      ...
      clock: [
        row("16:30", "arrive", "Arrive by 4:30. Concert t-shirt on. Open Tonight. Find the drink area. Tea, lemonade, ice, bottled water. Ask for donations. Not the serving line. Sound check is live — stay off the dance floor."),
    ...
    },
    {
      ...
      why: "One merch table. Drink donations live here. Merch 2 joins at 6:00 for the rush.",
      clock: [
        ...
        row("16:30", "arrive", "Night arrival by 4:30. T-shirt on. Open Tonight. Table live. Drink donations live here. 120 bottles on ice. Money bag on you. Sound check is live — stay off the dance floor."),
