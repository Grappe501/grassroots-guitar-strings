  ...
  const SPOTS = [
    {
      ...
      clock: [
        ...
        row("17:00", "work", "Dinner doors. Tell every night person: you stay until 10. Everything is inside. Concert-only stay in cars until 6:30. Ben does not plate. Water is $1 cash at merch. Tea and lemonade are free while they last."),
    ...
    },
    {
      ...
      why: "You lead the serving line. Three volunteers serve with you — Sarah plus two more. You do not plate. Water is sold at merch. Tea and lemonade are free while they last.",
      clock: [
        ...
        row("18:30", "work", "Line closes. Thank the three servers. Merch keeps selling water. You are off the line."),
    ...
    },
    {
      ...
      why: "Water is sold at the merch table. $1 cash only. You stand with Campaign. Not a second station. Not on Ben’s serving line.",
      clock: [
        ...
        row("15:10", "work", "120 bottles on ice at merch. $1 cash-only sign on that table. Money bag on you or with Campaign Lead. Ones for change. Tea and lemonade are free at the drink station — leave them alone."),
        row("15:30", "eat", "EAT now. 15 minutes."),
        row("16:30", "work", "SOUND CHECK. Stay off the dance floor. Bottles wait on ice at merch."),
        row("17:00", "work", "Dinner doors. You are live at merch. Script: water is $1 cash — or take free tea and lemonade while it lasts."),
    ...
    },
    {
      ...
      why: "30-minute merch set. Water is sold at this table. $1 cash. Close the table for David so you sit. Close it again for 45 minutes of the concert.",
      clock: [
        ...
        row("15:00", "arrive", "Night arrival by 3:00. Earlier if you can. T-shirt on. Open My Night. Table live. Water is sold here. 120 bottles on ice. $1 cash only. Money bag on you. Ones for change."),
        row("15:15", "eat", "EAT. 15 minutes. Sign: back in 10. Bottles stay on ice. Do not skip this."),
        row("16:30", "work", "SOUND CHECK. Stay off the dance floor."),
        row("17:25", "work", "Table. Talk. Sell water from this table. Script: water is $1 cash — or free tea and lemonade at the drink station. Do not leave shirts in a pile guests have to dig. Wave Relief each hour."),
