  ...
  const SPOTS = [
    {
      ...
      clock: [
        ...
        row("15:40", "work", "Ice with Ben. 12 bags in chests, not in a car. Merch has 120 bottles and the water bag. Water is sold at that table."),
    ...
    },
    {
      ...
      clock: [
        ...
        row("15:05", "work", "Dress the lobby table: cash box, envelopes, pens, $25 sign, kids $5 sign, teacher/first-responder note. No paper tickets. 10 minutes. Venue already placed the table."),
    ...
    },
    {
      ...
      clock: [
        row("15:00", "arrive", "Arrive by 3:00. Earlier if you can. Event t-shirt on. Open My Night. Walk the buffet. Three servers should be with you. Water is sold at merch. Not your station."),
        row("15:10", "work", "Ice chest + scoop for tea and lemonade. Set the line. Signs: we are taking donations for drinks. You do not plate."),
    ...
    },
    {
      ...
      clock: [
        ...
        row("15:10", "work", "Help set the line. Pans, utensils, plates at the start. Drinks are donations — water, tea, or lemonade. Do not take the merch drink bag."),
    ...
    },
    {
      ...
      clock: [
        ...
        row("15:10", "work", "Help set the line. Drinks are donations — water, tea, or lemonade. Do not take the merch drink bag."),
        row("15:30", "eat", "EAT now. 15 minutes."),
        row("16:30", "work", "SOUND CHECK. Stay off the dance floor."),
    ...
    },
    {
      ...
      n: 7,
      title: "Water",
      short: "Drink donations",
      arrive: "3:00 PM · earlier if you can",
      eat: "3:30 PM · 15 min. Then you stand at merch.",
      sit: "Stay on bottles during the acoustic set. Watch the concert 7:20–8:00 while Relief 2 covers merch.",
      roster: [{ kind: "event", hint: /\$1 bottles only/i }],
      why: "Drink donations live at the merch table. Water, tea, or lemonade. You stand with Campaign. Not a second cash station. Not on Ben’s serving line.",
      clock: [
        row("15:00", "arrive", "Arrive by 3:00. Earlier if you can. Event t-shirt on. Open My Night. Find the merch table. Water is sold there. Not the serving line."),
        row("15:10", "work", "120 bottles on ice at merch. Donation sign on that table. Money bag on you or with Campaign Lead. Tea and lemonade use the same donation message."),
        row("15:30", "eat", "EAT now. 15 minutes."),
        row("16:30", "work", "SOUND CHECK. Stay off the dance floor. Bottles wait on ice at merch."),
        row("17:15", "work", "Food doors. You are live at merch. Script: we are taking donations for drinks — water, tea, or lemonade."),
        row("17:30", "work", "Buffet rush. Keep the bag on the merch table. Do not set cash on the cooler."),
        row("17:45", "work", "Dinner show. Stay on bottles at merch. Listen from the table."),
        row("18:30", "work", "Line is done. You stay up at merch. Concert-door guests will want water."),
        row("19:00", "work", "Concert starts. Stay through the first songs unless Relief 2 has already tagged you at merch."),
        row("19:20", "sit", "SIT the concert 40 minutes. Relief 2 has the bag at merch."),
        row("20:00", "work", "Back on water at merch through the last song."),
        row("20:45", "strike", "Reconcile the water bag with Event Lead. Pack leftover bottles with merch."),
    ...
    },
    {
      ...
      clock: [
        ...
        row("15:00", "arrive", "Night arrival by 3:00. Earlier if you can. T-shirt on. Open My Night. Table live. Drink donations live here. 120 bottles on ice. Money bag on you."),
        row("15:15", "eat", "EAT. 15 minutes. Sign: back in 10. Bottles stay on ice. Do not skip this."),
        row("16:30", "work", "SOUND CHECK. Stay off the dance floor."),
    ...
    },
    {
      ...
      clock: [
        ...
        row("19:20", "work", "Cover merch water so they can sit the concert. Check ice every 15 minutes."),
    ...
    },
    {
      ...
      why: "You own the path signs from the gate and the 90-minute room. Paul puts the yard signs out. Three dressers. Then they become night seats. You are done at 12:30 unless you also claimed a night job.",
      clock: [
        ...
        row("12:30", "leave", "Release the 3 dressers. Lunch off site. They come back as Floater A, Floater B, or Campaign. Path signs stay until strike."),
