  ...
  const SPOTS = [
    {
      ...
      clock: [
        ...
        row("16:35", "work", "Walk 8 guest tables, lobby, buffet, merch, lot. Confirm every night post is walking in: tickets, Ben + 3 servers, water, campaign, both floaters, Kelly Support, Photo, 3 arrival. Text anyone missing."),
        row("16:45", "eat", "EAT. 15 minutes. Plate now so you are not hungry at doors."),
        row("17:00", "work", "Ice with Ben if it is not in. 12 bags in chests, not in a car. Merch has 120 bottles and the water bag. Drink donations at that table."),
    ...
    },
    {
      ...
      arrive: "4:30 PM",
      eat: "4:45 PM · 15 min. Then you stand at merch.",
      ...
      clock: [
        row("16:30", "arrive", "Arrive by 4:30. Event t-shirt on. Open My Night. Find the merch table. Drink donations live there. Not the serving line. Sound check is live — stay off the dance floor."),
        row("16:35", "work", "120 bottles on ice at merch. Donation sign on that table. Money bag on you or with Campaign Lead. Tea and lemonade use the same donation message."),
        row("16:45", "eat", "EAT now. 15 minutes."),
    ...
    },
    {
      ...
      short: "Tickets cover",
      arrive: "10:00 AM if you dress · 4:30 PM for night",
      eat: "Lunch off site after 12:30. Night plate at 4:40 — you stay on your post during the acoustic set.",
      ...
      clock: [
        ...
        row("12:30", "leave", "Morning done. Leave. Eat lunch off site. Back at 4:30."),
        row("16:30", "arrive", "Night arrival by 4:30. T-shirt on. Open My Night. Ice with Food. Walk every post once. Sound check is live — stay off the dance floor."),
    ...
    },
    {
      ...
      clock: [
        ...
        row("12:30", "leave", "Morning done. Leave. Eat lunch off site. Back at 4:30."),
        row("16:30", "arrive", "Night arrival by 4:30. T-shirt on. Open My Night. Start the loop on FOOD first so you are offset from Relief 1. Sound check is live — stay off the dance floor."),
        row("16:45", "eat", "EAT. 15 minutes. This is your dinner. You work David on purpose."),
