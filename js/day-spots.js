  ...
  const SPOTS = [
    {
      ...
      clock: [
        row("08:00", "arrive", "Arrive. Concert t-shirt on. Open your Spot page. Available for setup help. Tracy may be loading in. Furniture is already placed. Do not rebuild."),
        row("10:00", "work", "Available for setup help. If Paul and the dressers need a hand, you are there."),
        row("16:30", "work", "Night crew arrives. Available for questions and directions. Sound check is live — stay off the dance floor."),
    ...
    },
    {
      ...
      clock: [
        ...
        row("17:15", "work", "BBQ open. Keep the line moving. Refill pans. Do not plate guest plates."),
    ...
    },
    {
      ...
      clock: [
        ...
        row("17:15", "work", "Line is open. Serve. Smile. Ben directs."),
