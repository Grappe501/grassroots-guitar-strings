(function (global) {
  ...
  const SPOTS = [
    ...
    },
    {
      ...
      clock: [
        row("08:00", "arrive", "Tracy window opens. He arrives sometime 8:00–10:00 with a complete lights and sound system. Ready to go. Event t-shirt on. Find him when he walks in."),
        row("08:10", "work", "He has everything. Helper job is cables, tape, water, fetch if he asks. Do not build a second plot."),
        row("10:00", "work", "Tracy is on site by now. Band is not required this morning. They load in at 2:00. Sound check is 4:30."),
